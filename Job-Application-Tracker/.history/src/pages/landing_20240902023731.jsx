  ...
  return <main className='flex flex-col gap-10 sm:gap-20 py-10 sm:py-20'>
    <section className='text-center'>
      ...
      sm:text-6xl lg:text-8xl tracking-tighter py-4'>
        ...
        <span className='text-2xl sm:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 shadow-lg tracking-wider'>and get HIRED</span>
    </section>
    <div>
      {/*buttons */}
        {/*carousel */}
